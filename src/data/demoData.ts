...
export function createDemoTasks(): Task[] {
  ...
  return [
    {
      id: 'task-1',
      title: 'Sprint review z zespołem',
      status: 'active',
      isRefined: true,
      quickAssign: 'today',
      category: 'Praca',
      ...
      notes: 'Przejście po blockerach, velocity i ryzykach na przyszły tydzień.',
      subtasks: [
        { id: 'subtask-1-1', title: 'Przygotować slajd z velocity', completed: true, createdAt: oldIso },
        { id: 'subtask-1-2', title: 'Spisać 3 główne ryzyka', completed: false, createdAt: nowIsoValue },
        { id: 'subtask-1-3', title: 'Wysłać follow-up po spotkaniu', completed: false, createdAt: nowIsoValue },
      ],
      createdAt: oldIso,
    ...
    },
    {
      ...
      notes: 'Odpowiedzieć tylko na pilne wątki.',
      createdAt: yesterdayIso,
      updatedAt: nowIsoValue,
    },
    {
      id: 'task-3',
      title: 'Rozliczyć faktury od dostawców',
      status: 'active',
      isRefined: true,
      quickAssign: 'today',
      category: 'Praca',
      ...
      notes: 'Sprawdzić dwie zaległe pozycje i wysłać potwierdzenie.',
      createdAt: yesterdayIso,
      updatedAt: nowIsoValue,
    },
    {
      id: 'task-4',
      title: 'Kupić produkty na 3 dni',
      status: 'active',
      isRefined: true,
      quickAssign: 'today',
      category: 'Zakupy',
      ...
      subtasks: [
        { id: 'subtask-4-1', title: 'Sprawdzić lodówkę', completed: true, createdAt: yesterdayIso },
        { id: 'subtask-4-2', title: 'Kupić kapsułki do kawy', completed: false, createdAt: nowIsoValue },
      ],
    ...
    },
    {
      ...
      notes: 'Trening pleców plus 15 min mobilizacji.',
      createdAt: yesterdayIso,
      updatedAt: nowIsoValue,
    },
    {
      ...
      dueDate: tomorrow,
      plannedHours: 0.25,
      notes: 'Umówić termin kontroli i zapytać o wyniki badań.',
      createdAt: nowIsoValue,
      updatedAt: nowIsoValue,
    },
    {
      id: 'task-8',
      title: 'Przeczytać rozdział o normalizacji baz',
      status: 'active',
      isRefined: true,
      quickAssign: 'tomorrow',
      category: 'Nauka',
      ...
      dueDate: tomorrow,
      plannedHours: 1,
      notes: 'Skupić się na 2NF i 3NF oraz zrobić notatki.',
      createdAt: nowIsoValue,
      updatedAt: nowIsoValue,
    },
    {
      id: 'task-9',
      title: 'Przygotować plan dnia na jutro',
      status: 'active',
      isRefined: true,
      quickAssign: 'today',
      category: 'Osobiste',
    ...
    {
      id: 'task-10',
      title: 'Dopracować chapter o badaniu konkurencji',
      status: 'active',
      isRefined: true,
      quickAssign: 'later',
      category: 'Nauka',
      ...
      dueDate: closerLater,
      plannedHours: 2,
      notes: 'Dodać porównanie 3 aplikacji i krótkie wnioski.',
      createdAt: nowIsoValue,
      updatedAt: nowIsoValue,
    },
    {
      id: 'task-11',
      title: 'Oddać rzeczy do pralni',
      status: 'active',
      isRefined: true,
      quickAssign: 'later',
      category: 'Dom',
    ...
    {
      id: 'task-12',
      title: 'Spisać backlog funkcji do MVP 3',
      status: 'active',
      isRefined: true,
      quickAssign: 'later',
    ...
    {
      id: 'task-13',
      title: 'Kupić prezent urodzinowy dla Oli',
      status: 'active',
      isRefined: true,
      quickAssign: 'later',
      category: 'Rodzina',
    ...
    {
      id: 'task-14',
      title: 'Zrobić backup telefonu i zdjęć',
      status: 'active',
      isRefined: true,
      quickAssign: 'later',
      category: 'Inne',
    ...
    {
      id: 'task-15',
      title: 'Zaplanować urlop w górach',
      status: 'postponed',
      isRefined: true,
      quickAssign: 'later',
      category: 'Osobiste',
    ...
    {
      id: 'task-16',
      title: 'Przegląd kodu kolegi z zespołu',
      status: 'completed',
      isRefined: true,
      quickAssign: 'today',
      category: 'Praca',
    ...
    {
      id: 'task-18',
      title: 'Wysłać dokumenty do urzędu',
      status: 'active',
      isRefined: true,
      quickAssign: 'tomorrow',
      category: 'Inne',
      ...
      dueDate: inTwoDays,
      plannedHours: 0.75,
      notes: 'Sprawdzić, czy wszystkie załączniki są podpisane.',
      createdAt: nowIsoValue,
      updatedAt: nowIsoValue,
    },
    {
      id: 'task-19',
      title: 'Posprzątać kuchnię po weekendzie',
      status: 'active',
      isRefined: true,
      quickAssign: 'today',
      category: 'Dom',
    ...
    {
      id: 'task-20',
      title: 'Rozpisać pytania do promotora',
      status: 'active',
      isRefined: true,
      quickAssign: 'today',
      category: 'Nauka',
      ...
      notes: 'Pytania o zakres ewaluacji i rozdział wdrożeniowy.',
      createdAt: yesterdayIso,
      updatedAt: nowIsoValue,
    },
    {
      id: 'task-21',
      title: 'Odebrać mamę z dworca',
      status: 'active',
      isRefined: true,
      quickAssign: 'today',
      category: 'Rodzina',
    ...
    {
      id: 'task-22',
      title: 'Zrobić research o lokalnych coworkach',
      status: 'active',
      isRefined: false,
      quickAssign: 'today',
      dueDate: today,
...
export function createDemoNotes(): NoteItem[] {
  ...
  return [
    ...
    },
    {
      id: 'note-3',
      title: 'Urodziny Ani',
      content: 'Prezent: bon do księgarni albo coś z wellness.',
      section: 'birthdays',
      personName: 'Ania',
    ...
    },
    {
      ...
      content: 'Słuchawki, porządny notes, bon do sklepu z kawą.',
      section: 'my-wishes',
      createdAt: now,
      updatedAt: now,
    },
    {
      ...
      content: 'Lubi LEGO Technic, gry logiczne i kawę specialty.',
    ...
    {
      id: 'note-6',
      title: 'Lista zakupów domowych',
      content: 'Środek do łazienki, worki na śmieci, kapsułki do prania, ręczniki papierowe.',
      section: 'general',
      createdAt: now,
      updatedAt: now,
    },
    ...
    {
      id: 'note-10',
      title: 'Prezenty dla siebie na później',
